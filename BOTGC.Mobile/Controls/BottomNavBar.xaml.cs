...
public partial class BottomNavBar : ContentView
{
    ...
    void ApplySelection(string key)
    {
        ...
        SetTab(ProgressLabel, ProgressIcon, key == "progress", selectedText, unselectedText, "nav_progress_orange.png", "nav_progress.png", isBold: true);
        SetTab(VouchersLabel, VouchersIcon, key == "vouchers", selectedText, unselectedText, "nav_vouchers_orange.png", "nav_vouchers.png", isBold: true);
        SetTab(MentorLabel, MentorIcon, key == "mentor", selectedText, unselectedText, "nav_mentor_orange.png", "nav_mentor.png", isBold: true);
        SetTab(PlayLabel, PlayIcon, key == "play", selectedText, unselectedText, "nav_play_orange.png", "nav_play.png", isBold: true);
    }
