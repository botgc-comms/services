    ...
    public class JuniorEclecticCompetitionProcessorTests
    {
        ...
        public static IEnumerable<object[]> GetTestData()
        {
            ...
            foreach (var file in testFiles)
            {
                ...
                yield return new object[] { testCase, testCase.TestName ?? Path.GetFileNameWithoutExtension(file) };
            }
        }

        [Theory]
        [MemberData(nameof(GetTestData))]
        public async Task ProcessCompetitionAsync_ProducesCorrectEclecticScorecard(JuniorEclecticCompetitionProcessorTestCase testCase, string testName)
        {
