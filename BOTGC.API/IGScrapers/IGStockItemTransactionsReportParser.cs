...
{
    public class IGStockItemTransactionsReportParser : IReportParser<StockItemTransactionReportEntryDto>
    {
        private readonly ILogger<IGStockItemTransactionsReportParser> _logger;

        public IGStockItemTransactionsReportParser(ILogger<IGStockItemTransactionsReportParser> logger)
        {
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
        }

        public async Task<List<StockItemTransactionReportEntryDto>> ParseReport(HtmlDocument document)
        {
            var results = new List<StockItemTransactionReportEntryDto>();
            ...
            foreach (var tr in rows)
            {
                ...
                var dto = new StockItemTransactionReportEntryDto
                {
